        ...
        <div className="flex flex-col flex-wrap w-2/3 m-auto">
            ...
            <div className="flex flex-col m-auto py-5 w-full">
                ...
                <div className="flex flex-wrap w-full md:w-1/2 md:m-auto">
                    ...
                    <div className="relative w-1/2 mt-5">
                        <motion.div initial="hidden" animate={backPressed ? 'list' : 'hidden'} variants={bubbleVariants} className="absolute text-lg md:text-xl">
                    ...
                    <div className="relative w-1/2 mt-5">
                        <motion.div initial="hidden" animate={otherPressed ? 'list' : 'hidden'} variants={bubbleVariants} className="absolute text-lg md:text-xl my-5">
